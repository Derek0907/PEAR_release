...
class SegFormer(nn.Module):
    def __init__(self, num_classes = 21, phi = 'b0', pretrained = False, weights = None):
        ...
        }[phi](pretrained=pretrained, weights=weights)
        self.embedding_dim   = {
...
if __name__ == '__main__':
    model = SegFormer(num_classes=1, phi='b2', pretrained=True)
    model.eval()
